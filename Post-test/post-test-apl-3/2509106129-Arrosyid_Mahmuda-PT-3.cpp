...
void lihatAlat(Alat data[], int jumlah){
    if(jumlah == 0){
...
void tambahAlat(Alat data[], int &jumlah){
...
void ubahAlat(Alat data[], int jumlah){
...
void hapusAlat(Alat data[], int &jumlah){
...
void beliAlat(Alat data[], int jumlah){
