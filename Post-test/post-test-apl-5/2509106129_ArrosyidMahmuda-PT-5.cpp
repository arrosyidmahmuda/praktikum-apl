            ...
            if(role == "admin"){
                ...
                do{
                    ...
                    if(pilih==1) tambahAlat(daftarAlat, &totalAlat);
                        ...
                        if(s==1){ sortNamaAsc(daftarAlat, totalAlat);
                        lihatAlat(daftarAlat, totalAlat);
                    }
                        else if(s==2){ sortJumlahDesc(daftarAlat, totalAlat);
                        lihatAlat(daftarAlat, totalAlat);
                    }
                        else if(s==3){ sortIdAsc(daftarAlat, totalAlat);
                        lihatAlat(daftarAlat, totalAlat);
                    }
